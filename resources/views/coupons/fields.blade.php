...
@if(isset($coupon) )
<input data-id="{{$coupon->id}}" name="status"   type="checkbox" {{ $coupon->status ? 'checked' : '' }}  data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on="Active" data-off="InActive">
@else
